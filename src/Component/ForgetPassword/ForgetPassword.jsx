...
<form onSubmit={ForgetForm.handleSubmit}>
    ...
    <input onChange={ForgetForm.handleChange} onBlur={ForgetForm.handleBlur} type="text" name="email" id="email" className='form-control w-75 mb-2'  />
...
<form onSubmit={resetForm.handleSubmit}>
    ...
    <input onBlur={resetForm.handleBlur} onChange={resetForm.handleChange} type="text" name='resetCode' id='resetCode' className='form-control w-75 mb-2' />
